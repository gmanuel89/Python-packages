...
## Retrieves the list of dataset for a Project revision with all their information
def get_dataset_info_list_for_project(project_uid: int, tenant_url: str, tenant_api_key: str, project_revision=0) -> list[dict]:
    # Initialise output
    dataset_info_list = []
    # Fix tenant URL
