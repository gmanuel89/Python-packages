...
def get_signals_inventa_attribute_list(signals_inventa_tenant_url: str, signals_inventa_tenant_api_key: str, selected_entities=[]) -> list[dict]:
    # Initialise output
    ...
    try:
        signals_inventa_attribute_list_response = requests.get(signals_inventa_tenant_url + signals_inventa_tenant_api_url_suffix,
