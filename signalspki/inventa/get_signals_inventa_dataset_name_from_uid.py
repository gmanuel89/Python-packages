...
def get_signals_inventa_dataset_name_from_uid(signals_inventa_dataset_uid: int, signals_inventa_project_uid: int, signals_inventa_tenant_url: str, signals_inventa_tenant_api_key: str) -> int:
    # Initialise output
    dataset_name = None
    # Fix tenant URL
    ...
    try:
        ...
        for ds in signals_inventa_project_datasets_response_content.get('datasets'):
            if ds.get('uid') == signals_inventa_dataset_uid:
