...
def get_signals_inventa_project_dataset_uid_from_name(signals_inventa_project_dataset_name: str, signals_inventa_project_name: str, signals_inventa_project_revision: int, signals_inventa_tenant_url: str, signals_inventa_tenant_api_key: str) -> int:
    # Initialise output
    dataset_uid = None
    # Fix tenant URL
